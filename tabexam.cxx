...
#include <cstring> //provides memory
...
/*
Look this seems to work fine for everyone, however, one
strudent in Sp 2021, did not get the operator delete to be called!

Under Visual Studio he called:
  remove (void*, void* )
...
//  HAM Moved to table2.h for student clarity
// **************************************************************************
// TRec type
//   Each table will use the following data type for its entries.
// **************************************************************************
//struct TRec
//{
//    int key;
...
// **************************************************************************
// MAX_KEY
//    Used by the exam to create keys ranging from 0 through MAX_KEY.
// **************************************************************************
...
int main( )
{
    ...
    std::cerr << "If you submit this Chained Hashing Program to Canvas now, this part of the \n";
